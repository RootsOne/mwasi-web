...
var __VLS_self = (await Promise.resolve().then(function () { return require('vue'); })).defineComponent({
    setup: function () {
        return {
            cn: utils_1.cn,
            DropdownMenuSubContent: reka_ui_1.DropdownMenuSubContent,
            forwarded: forwarded,
        };
    },
    __typeEmits: {},

...
var __VLS_0 = {}.ComboboxItem;
/** @type {[typeof __VLS_components.ComboboxItem, typeof __VLS_components.ComboboxItem, ]} */ ;
// @ts-ignore
...
var __VLS_2 = __VLS_1.apply(void 0, __spreadArray([__assign(__assign({ dataSlot: "combobox-item" }, (__VLS_ctx.forwarded)), { class: (__VLS_ctx.cn("data-[highlighted]:bg-accent data-[highlighted]:text-accent-foreground [&_svg:not([class*='text-'])]:text-muted-foreground relative flex cursor-default items-center gap-2 rounded-sm px-2 py-1.5 text-sm outline-hidden select-none data-[disabled=true]:pointer-events-none data-[disabled=true]:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4", props.class)) })], __VLS_functionalComponentArgsRest(__VLS_1), false));
var __VLS_4 = {};
...
var __VLS_self = (await Promise.resolve().then(function () { return require('vue'); })).defineComponent({
    setup: function () {
        return {
            cn: utils_1.cn,
            ComboboxItem: reka_ui_1.ComboboxItem,
            forwarded: forwarded,
        };
    },
    __typeEmits: {},
